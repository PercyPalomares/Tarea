...
def app():
    ...
    st.subheader('Creamos el modelo de Regresión Logística')
    st.subheader('usamos LogisticRegression')
    ...
    st.write("Precisión del modelo Regresión Logística: {:>7.4f}".format(logisticRegr.score(X_test, y_test)))
